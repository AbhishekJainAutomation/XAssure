...
class WebControlsLibrary implements Controls {
	WebDriver driver;
	...
	@Inject
	public WebControlsLibrary(WebDriver driver) {
		this.driver = driver;
	...
	public boolean clickUsingJavaScriptExecutor(String elementName, String property) {
		...
		try {
			...
			for (WebElement element : elements) {
				...
				if (ele != null) {
					highlighElement(ele);
					jsExec.executeScript("arguments[0].click();", new Object[] { ele });
					bFlag = true;
			...
			Reporting.getLogger().log(LogStatus.FAIL, "Timeout Exception occured while clicking on element '"
					+ elementName + "' using javascript executor", (Exception) e);
		} catch (Exception e) {
			Reporting.getLogger().log(LogStatus.FAIL,
					"Exception occured while clicking on element '" + elementName + "' using javascript executor", e);
		}
	...
	public void enterTextUsingJavascriptExecutor(String elementName, String property, String textToEnter) {
		...
		try {
			...
			for (WebElement element : elements) {
				...
				if (visibilityofWebelement(element)) {
					jsExec.executeScript("arguments[0].value='" + textToEnter + "'", new Object[] { element });
					bFlag = true;
					break;
				}
			}
	...
	public boolean isTextBoxEditable(String elementName, String property) {
		...
		try {
			...
			for (WebElement element : elements) {
				...
				if (visibilityofWebelement(element)) {
					element.sendKeys(new CharSequence[] { "test" });
					element.clear();
					bFlag = true;
					break;
				}
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Timeout Exception while checking Text box is editable for'" + elementName, (Exception) t);
		} catch (Exception e) {
			Reporting.getLogger().log(LogStatus.FAIL,
	...
	public void executeJavaScript(String javaScript) {
		try {
			...
			js.executeScript(javaScript, new Object[0]);
		} catch (Exception e) {
	...
	public boolean doubleClick(String elementName, String property) {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Timeout Exception occured while performing double click on element " + elementName, (Exception) t);
		} catch (Exception e) {
			Reporting.getLogger().log(LogStatus.FAIL,
	...
	public boolean rightClick(String elementName, String property) {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Timeout Exception occured while performing right click on element " + elementName, (Exception) t);
		} catch (Exception e) {
			Reporting.getLogger().log(LogStatus.FAIL,
	...
	public String getValueOfAttribute(String elementName, String property, String attribute) {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL, "Timeout Exception while fetching value of attribute '"
					+ attribute + "' for element " + elementName, (Exception) t);
		} catch (Exception e) {
			Reporting.getLogger().log(LogStatus.FAIL,
	...
	public List<String> getTextFromWebElementList(String elementName, String property) {
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Exception occured while fetching text from element list for locator " + elementName, e);
	...
	public boolean isElementExists(String elementName, String property) {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Timeout Exception occured while checking the existance of element '" + elementName, (Exception) t);
		} catch (Exception e) {
	...
	public boolean switchAndAcceptAlert() {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL, "Timeout Expetion occured while accepting Alert", (Exception) t);
		} catch (Exception e) {
	...
	public boolean switchAndCancelAlert() {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL, "Timeout Exception while canceling the Alert", (Exception) t);
		} catch (Exception e) {
	...
	public boolean switchToIframe(String elementName, String property) {
		...
		try {
			...
			Reporting.getLogger().log(LogStatus.FAIL,
					"Timeout Exception occured while switching to iframe " + elementName, (Exception) t);
	...
	private WebElement getWebelement(String locator, String locatorValue) {
		try {
			...
			driverWait.pollingEvery(this.pollingDuration);
			driverWait.withTimeout(this.timeOutDuration);
		...
		try {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.id(locVal));
						}
					};

					element = (WebElement) driverWait.until(waitForElement);
					if (this.locatorTimeFlag) {
						stopwatch.stop();
			...
			if (locator.equalsIgnoreCase("xpath")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.xpath(locVal));
						}
					};
			...
			if (locator.equalsIgnoreCase("className")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.className(locVal));
						}
					};
			...
			if (locator.equalsIgnoreCase("name")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.name(locVal));
						}
					};
			...
			if (locator.equalsIgnoreCase("tagName")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.tagName(locVal));
						}
					};
			...
			if (locator.equalsIgnoreCase("css")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.cssSelector(locVal));
						}
					};
			...
			if (locator.equalsIgnoreCase("linkText")) {
				...
				try {
					Function<WebDriver, WebElement> waitForElement = new Function<WebDriver, WebElement>() {
						public WebElement apply(WebDriver driverWait) {
							return WebControlsLibrary.this.getDriver().findElement(By.linkText(locVal));
						}
					};
	...
	private boolean visibilityofWebelement(WebElement element) {
		try {
			...
			_waitForElement.withTimeout(this.timeOutDuration);
	...
	private WebElement verifyElementClickable(WebElement element) {
		try {
			WebDriverWait wait = new WebDriverWait(getDriver(), 40L);
	...
	private void checkAvailableLocators(Map<String, List<String>> locatorsMapValues, List<WebElement> elements,
		...
		Set<String> expectedLocators = new HashSet<>(
				Arrays.asList(new String[] { "id", "xpath", "linkText", "css", "name", "class" }));
	...
	private List<WebElement> getWebElementsOfElement(String locator, String locatorValue) {
		...
		try {
			if (locator.equalsIgnoreCase("id")) {
				...
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.id(locVal));
					}
				};

				elements = (List<WebElement>) driverWait.until(waitForElement);
			}
			if (locator.equalsIgnoreCase("xpath")) {

				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.xpath(locVal));
					}
				};
			...
			if (locator.equalsIgnoreCase("className")) {
				...
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.className(locVal));
					}
				};
			...
			if (locator.equalsIgnoreCase("name")) {
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.name(locVal));
					}
				};
			...
			if (locator.equalsIgnoreCase("tagName")) {
				...
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.tagName(locVal));
					}
				};
			...
			if (locator.equalsIgnoreCase("css")) {
				...
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.cssSelector(locVal));
					}
				};
			...
			if (locator.equalsIgnoreCase("linkText")) {
				...
				Function<WebDriver, List<WebElement>> waitForElement = new Function<WebDriver, List<WebElement>>() {
					public List<WebElement> apply(WebDriver driverWait) {
						return WebControlsLibrary.this.getDriver().findElements(By.linkText(locVal));
					}
				};
