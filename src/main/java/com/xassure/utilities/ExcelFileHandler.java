		...
		try {
			...
			for (Map<String, String> rowSet : rows) {
				...
				for (String key : rowSet.keySet()) {
					...
					if (row.isEmpty()) {
						row = "'" + (String) rowSet.get(key) + "'";
						continue;
					}
					row = row + ",'" + (String) rowSet.get(key) + "'";
				}
		...
		try {
			...
			for (String col : colValMap.keySet()) {
				if (updateColString.isEmpty()) {
					updateColString = col + "='" + (String) colValMap.get(col) + "'";
					continue;
				}
				updateColString = updateColString + "," + col + "='" + (String) colValMap.get(col) + "'";
			}

			String whereClauseString = "";
			for (String whereCol : whereClauseMap.keySet()) {
				if (whereClauseString.isEmpty()) {
					whereClauseString = whereCol + "='" + (String) whereClauseMap.get(whereCol) + "'";
					continue;
				}
				whereClauseString = whereClauseString + " and " + whereCol + "='"
						+ (String) whereClauseMap.get(whereCol) + "'";
			}
